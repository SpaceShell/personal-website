...
export default function ProjectSlide({
    ...
    return (
        <div className={"border-4 border-red-700 dark:border-red-500 rounded-2xl w-full max-w-lg h-full lg:mb-0 mb-8 min-w-0 basis-[32%] " + addedClasses}>
            <Link href={href}>
            ...
            <Disclosure as="div" defaultOpen={false}>
                ...
                <DisclosurePanel transition className='text-sm/5 px-6 rounded-b-xl origin-top transition-all duration-1000 ease-out max-h-screen data-[closed]:max-h-0 overflow-hidden'>
                    ...
                    <h4>Top Skills <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-4 inline-block mb-1">
