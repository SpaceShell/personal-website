        ...
        <section>
            <div>
                <h2 className="sectionTitle md:mx-32 mx-10 mb-16">My Experience</h2>
                    <div className="flex flex-col gap-16 relative max-w-full after:content-[''] after:w-1.5 after:h-[100%] after:lg:h-[100%] after:bg-gradient-to-b after:from-red-900 dark:after:from-red-700 after:from-90% after:to-transparent after:absolute after:left-[4rem] sm:after:left-[5rem] after:lg:left-[21rem] after:md:left-[15rem] after:top-5">
