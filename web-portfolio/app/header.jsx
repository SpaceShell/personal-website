...
import Computer from "./rive-anims/comp-anim"
...
export default function Header() {
    return(
        <header className='flex md:flex-row flex-col justify-evenly relative'>
            <SideConnect />
            <div className="relative grow md:ml-40 ml-10">
                <div className="flex flex-row md:mt-20 mt-7 headerText">
                    <MdOutlineLocationOn className="size-6 fill-black"/>
                    <p className="ml-1 mt-0.5">United States, California</p>
                </div>
                <SplitLetters />
                <h1 className="font-ExBoldsarabun text-6xl relative for-sr">Hello, I'm <br className="sm:hidden" aria-hidden="true"></br>Steve Luis!</h1>
                <p className={sarabunSemi.className + " text-3xl headerText md:mt-6 mt-9 text-gray-900"}>I am a...</p>
                    <div className="relative triangular md:w-2/3 text-gray-900 mt-0.5">
