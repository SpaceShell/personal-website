    ...
    return(
        <header className='text-center flex flex-col justify-evenly relative'>
            ...
            <div className="relative grow">
                ...
                <div className="relative mt-7 triangular">
                    <p id="face1" className={"font-sarabun mt-7 font-bold text-2xl headerText"} style={{
                        "--initialRotateX": "0"
                    }}><span className="text-teal-500">Web</span> Developer</p>
                    <p id="face2" className={"font-sarabun font-bold text-2xl headerText absolute top-0 bottom-0 w-full"} style={{
                        "--initialRotateX": "120deg"
                    }}>Front-End Engineer</p>
                    <p id="face3" className={"font-sarabun font-bold text-2xl headerText absolute top-0 bottom-0 w-full"} style={{
