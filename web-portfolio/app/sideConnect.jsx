...
export default function SideConnect() {
    return (
        <aside className='hidden lg:block fixed left-2 top-[70px] h-full w-1/12 after:content-[""] before:w-1 before:h-2/3 before:bg-gray-400 before:block before:mx-auto before:sticky'>
            ...
            <a href='https://github.com/SpaceShell'>
                <FaGithub className='mx-auto mt-3 size-9 text-gray-700 dark:text-gray-100'/>
            </a>
        </aside>
    )
}